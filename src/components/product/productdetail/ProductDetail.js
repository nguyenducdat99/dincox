...
function ProductDetail(props) {
  ...
  const { id_product, id_category, product_name, price, description, is_sale } =
    currentProduct;
  ...
  const addToCart = () => {
    onAddToCartRec(
      currentProduct,
      listSizeSelect[sizeSelected].id_size,
      quantity
    );
  ...
  if (is_sale && saleDetails.length > 0)
    discount =
      ConvertState.findDiscountForProduct(id_product, saleDetails).length > 0
        ? ConvertState.findDiscountForProduct(id_product, saleDetails)[0]
            .discount
        : discount;
            ...
            <div className="product-detail__content">
              ...
              <div className="product-detail__content__header">
                ...
                <div className="product-detail__content__header__brand">
                  <p>
                    Thương Hiệu: <a href="/#">Dincox</a>
                  </p>
                </div>
                <span> | </span>
                <div className="product-detail__content__header__type">
                  <p>
                    Loại: <a href="/#">{categoryName}</a>
                  </p>
                </div>
                <span> | </span>
              ...
              <div className="product-detail__content__transport">
                ...
                <div className="product-detail__content__transport__item">
                  ...
                  <div>
                    ...
                    <p>
                      + Bảo hành đổi mới các sản phẩm bị lỗi của nhà sản xuất
                      trong vòng 6 tháng,
